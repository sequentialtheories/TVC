 ...
 */
export function step(prev, input, week, totalWeeks, rigorLevel, customAmount) {
...
export function run(inputs) {
    ...
    return {
        ...
        finalTotal: applyRounding(current.capital + current.yield + current.momentum + current.wBTC),
        totalWeeks
    };
}
