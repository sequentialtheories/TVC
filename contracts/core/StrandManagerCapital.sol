...
contract StrandManagerCapital is IStrandManager, Ownable, ReentrancyGuard, Pausable {
    ...
    // Constants
    uint256 private constant TARGET_APY = 500; // 5%
    ...
    function deployFunds(uint256 amount) public override onlyMegaVault nonReentrant whenNotPaused {
        ...
        // In production, this would deploy to AAVE stablecoin lending
    ...
    function harvestYield() external override onlyMegaVault nonReentrant whenNotPaused returns (uint256) {
        uint256 currentYield = availableYield;
    ...
    function rebalance() external override onlyMegaVault nonReentrant {
        // Capital strand rebalancing logic
        // Ensure optimal allocation for emergency reserves and wBTC purchases
    ...
    function validateStrategy(address _strategy) external view override returns (bool) {
