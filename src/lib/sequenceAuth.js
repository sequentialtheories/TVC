...
export const authenticateWithSequenceTheory = async (email, password) => {
  try {
    const response = await fetch(`${window.__TVC_CONFIG.functionsBase}/vault-club-auth-sync`, {
      method: 'POST',
      headers: {
...
export const createSequenceTheoryAccount = async (email, password, name) => {
  try {
